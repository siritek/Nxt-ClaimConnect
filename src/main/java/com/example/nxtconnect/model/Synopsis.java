...
public class Synopsis {
    ...
    private String currentReserves;
    ...
    public String getCurrentReserves() {
        return currentReserves;
    }

    public void setCurrentReserves(String currentReserves) {
    ...
    public void setScheduledPayments(String scheduledPayments) {
